...
public class ClientIT {
    ...
    public static final String EXIST_NAME = "Ana";

    private static final Long MODIFY_CLIENT_ID = 3L;
    private static final Long DELETE_CLIENT_ID = 3l;
